...
<main class="blog-post">
    <div class="container">
        ...
        <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">•
            {{$date->format('F   Y   d   H:i')}} pm • {{$post->comments->count()}} Comments</p>
        ...
        <div class="row">
            <div class="col-lg-9 mx-auto">
                <section class="related-posts">
                    ...
                    <div class="row">
                        @foreach($relationPosts as $relatedPost)
                        ...
                        <div class="row">
                            <div class="form-group col-12" data-aos="fade-up">
                                ...
                                <textarea name="massage" id="comment" class="form-control"
                                    placeholder="Leave your comment" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12" data-aos="fade-up">
                                <input type="submit" value="Send Comments" class="btn btn-warning">
                            </div>
                        </div>
                    </form>
                </section>
