                ...
                <div class="collapse navbar-collapse" id="edicaMainNav">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="{{route('main.index')}}">Blog</a>
                        </li>
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            @auth()
                            <a class="nav-link dropdown-toggle" href="{{route('personal.main.index')}}">Personal
                                page</a>
                            @endauth
                            @guest
                            <a class="nav-link dropdown-toggle" href="{{route('personal.main.index')}}">Enter</a>
                            @endguest
                        </li>
                    </ul>
                </div>
